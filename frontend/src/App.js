    ...
    <Router >
      <div>
        ...
        <Routes>
          ...
          <Route path="/services/listings" element={<ServiceListings categoryId={'Maid'} maids={maids} location={currAddress} />} />
          <Route path="/services/listings/service/:id" element={<ServiceDetails maids={maids} serviceUser={serviceUser} location={currAddress}/>} />
